...
class TestFailedApiAlertMiddleware(BaseTestCase):
    ...
    @override_settings(FAILED_API_ALERT_STATUS_CODES=[400], FAILED_API_ALERT_NAMESPACES=["v1"])
    def test_signal_not_triggered_when_register_success_w_201_status_code(self, mock_signal_send):
        ...
        print(">> test_signal_not_triggered_when_register_success_w_201_status_code: OK <<")

    @patch("config.middleware.failed_api.failed_api_alert_triggered.send")
    @override_settings(FAILED_API_ALERT_STATUS_CODES=[400], FAILED_API_ALERT_NAMESPACES=["v1"])
    def test_signal_triggered_when_register_failed_w_400_status_code_there_no_password_in_payload(self,
                                                                                                  mock_signal_send):
        self.given_url(reverse("v1:auth-register"))
        ...
        print(">> test_signal_triggered_when_register_failed_w_400_status_code_there_no_password_in_payload: OK <<")
