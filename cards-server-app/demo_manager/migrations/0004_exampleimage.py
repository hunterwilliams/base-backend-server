# Generated by Django 4.1.2 on 2023-03-30 10:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', demo_manager.models.resize_image.CustomImageField(aspect_ratios=[None], blank=True, breakpoints={'l': 1200, 'm': 992, 's': 768, 'xl': 1400, 'xs': 576}, container_width=1200, file_types=['WEBP'], grid_columns=1, height_field='picture_height', max_file_size=None, null=True, pixel_densities=[1], upload_to='pictures', width_field='picture_width')),
            ],
        ),
    ]
